...
public:
    ...
    /**
     * @brief SaveState - save the game and return a new memento class
     * @return
     */
    Memento* SaveState();
    /**
     * @brief RestoreToMemento - reset the game to previous shot of cue ball
     * @param a
     */
    void RestoreToMemento(Memento* a);
    ...
    /**
     * @brief getIntoChannel - when balls get into the channel, change the position of balls
     * @param ball
     * @param channel
     */
    void getIntoChannel(Ball* ball, std::vector<Channel*> channel);
